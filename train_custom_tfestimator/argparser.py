...
from train_custom_tfestimator.config import FILE_DATE_FORMAT, INT_NUM_FEAT
from train_custom_tfestimator.utils import parse_date, find_latest_model_dir

import tensorflow as tf
import os

def parse_args():
    parser = ArgParser(default_config_files=[os.getcwd() + '/train_custom_tfestimator/initial_configurations/default'])
    # Core setting
